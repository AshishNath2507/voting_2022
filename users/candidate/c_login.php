                ...
                <svg version="1.1" class="logo" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" xml:space="preserve">
                    ...
                    <g>
                        ...
                        <div class="container-sm ">
                            ...
                            ?>
                            <form action="../../backend/c_login1.php" method="POST">
                                ...
                                <div class="mb-3 w-25 mx-auto">
                                    <label for="date" class="form-label fs-5">DOB as Password</label>
                                    <input type="date" name="dob" class="form-control" id="date" required>
                                </div>
                                <div class="mb-3 w-25 mx-auto">
                                    <button type="submit" name="canLogin" class="btn btn-dark">Submit</button>
                                </div>
                            </form>
                        </div>
                    </g>
