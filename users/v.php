                    ...
                    <div class="row gap">
                        ...
                        ?>
                            <div class="form-check border border-info w-50">
                                <input class="form-check-input" type="radio" name="<?php echo $row['p_id']; ?>" id="<?php echo $row['p_id']; ?>" value="<?php echo $war['user_id']; ?>" required>
...
<body>
    ...
    <div class="container-fluid">
        <form action="" method="POST">
            <div class="container d-grid">
                <div class="row gap">
                    ...
                    ?>
                            ...
                            ?>
                                <div class="form-check border p-4 w-50">
            ...
            <?php
            if ($start = mysqli_num_rows($post_query)) {
            ?>
                <button class="btn btn-primary mx-5 mt-4" type="submit" name="voteSubmit">Vote</button>
            <?php
            }
            ?>
        </form>
