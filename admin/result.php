            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100  px-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                        ...
                        <div class="col-xl-10 col-lg-10 ">
                            <div class="card shadow mb-1">
                                ...
                                <div class="card-header py-3 d-flex flex-column align-items-center">
                                    <h6 class="m-0 font-weight-bold text-primary mb-3">Vote Count</h6>
                                    <div class="container-sm">
                                        <div class="row">
                                            <div class="col align-item-center justify-content-left">
                                                <div class="col">
                                                    <a href="../backend/resetElection.php" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm" id="resetModal">Reset Current Voting Session</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
