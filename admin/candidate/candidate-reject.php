...
<head>
    ...
    <title>Admin - Candidates Reject Table</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                ?>
                                                    <td>
                                                        <button class="btn btn-success btn-sm rejbtn" name="submit" value="<?php echo $row["id"]; ?>">
                                                            <span class=""><?php echo $row["cand_approval"] ?></span>
                                                        </button>
                                                    </td>
                                                    <?php
                                                } else if ($row['cand_approval'] == "rejected") {
                                                    ?>
                                                    <td>
                                                        <button class="btn btn-secondary btn-sm" disabled><?php echo $row["cand_approval"]?></button>
                                                    </td>
                                                    <?php
                                                    ...
                                                    ?>
                                                        <td>
                                                            <button class="btn btn-danger btn-sm" disabled><?php echo $row["cand_approval"]?></button>
                                                        </td>
                                                <?php
                                                }
                                                ?>
                        ...
                        <!-- Delete Modal HTML -->
                        <div id="rejModal" class="modal fade">
                                ...
                                <div class="modal-content">
                                    <form action="../../backend/allcand.php" method="POST">
                                        ...
                                        <div class="modal-body">
                                            <input type="text" name="rej_id" class="rej_user_id" readonly>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="submit" name="rejCandButton" class="btn btn-danger" value="Reject">
                                        </div>
                                    </form>
                                </div>
                            </div>
